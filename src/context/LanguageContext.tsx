...
const translations: Record<Language, Record<string, string>> = {
  ml: {
    ...
    faq_a8: "വെബ്‌സൈറ്റിലെ 'Spawn Order' ബട്ടൺ വഴിയോ അല്ലെങ്കിൽ നേരിട്ട് WhatsApp +91 98765 43210 (ഡെമോ) ലേക്ക് മെസ്സേജ് അയച്ചോ ഓഡർ ചെയ്യാം.",
  ...
  en: {
    ...
    faq_a8: "Click 'Order Spawn' on website or message us directly on WhatsApp +91 98765 43210 (Demo number).",
